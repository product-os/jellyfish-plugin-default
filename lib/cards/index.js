...
module.exports = ({
	...
	const defaultCards = [
		...
		require('./contrib/brainstorm-call.json'),
		...
		// ProductOS
		require('./product-os/image.json'),
		require('./product-os/image-source.json'),

		require('./product-os/loop.js'),
		require('./product-os/loop-product-os.js'),
		require('./product-os/role-loop.json'),
		require('./product-os/role-transformer-worker.json'),
		require('./product-os/task'),
		require('./product-os/transformer.json'),
		require('./product-os/transformer-worker.json'),
		require('./product-os/view-all-transformer-workers.json'),
		require('./product-os/view-all-transformers.json')
	]
