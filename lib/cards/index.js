...
module.exports = [
	...
	require('./contrib/project.js'),
	require('./contrib/rating.js'),
	require('./contrib/saga.js'),
	...
	require('./balena/view-all-improvements.json'),
	...
	require('./balena/view-all-sagas.json'),
