...
module.exports = [
	...
	// Triggered actions
	require('./contrib/triggered-action-pull-request-artifact-ready.json'),
	require('./contrib/triggered-action-pull-request-artifact-ready-initial.json'),
