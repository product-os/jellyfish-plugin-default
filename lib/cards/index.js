...
module.exports = [
	...
	require('./contrib/triggered-action-support-closed-pattern-reopen.json'),
	...
	require('./contrib/view-my-starred-thread-messages.json'),
	...
	require('./balena/oauth-provider-balena-api.json'),
	require('./balena/oauth-provider-outreach.json'),
	require('./balena/oauth-client-balena-api'),
	require('./balena/oauth-client-outreach'),
